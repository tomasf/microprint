...
+ (TFPGCodeProgram*)testBorderProgram {
	...
	NSArray *codes = @[
					   ...
					   [TFPGCode moveWithPosition:[TFP3DVector vectorWithX:@(minX) Y:@(minY) Z:@(initialZ)] feedRate:feedrate],
					   [TFPGCode turnOnFanCode],
					   [TFPGCode codeForHeaterTemperature:temperature waitUntilDone:YES],
					   
					   [TFPGCode moveWithPosition:[TFP3DVector zVector:Z] extrusion:@(initialExtrusion) feedRate:-1],
					   [TFPGCode waitCodeWithDuration:cornerWaitTime],
					   [TFPGCode relativeModeCode],
					   [TFPGCode codeForExtrusion:cornerExtrusion feedRate:-1],
					   
					   [TFPGCode moveWithPosition:[TFP3DVector xVector:deltaX] extrusion:@(deltaXE) feedRate:-1],
					   [TFPGCode waitCodeWithDuration:cornerWaitTime],
					   [TFPGCode codeForExtrusion:cornerExtrusion feedRate:-1],
					   
					   [TFPGCode moveWithPosition:[TFP3DVector yVector:deltaY] extrusion:@(deltaYE) feedRate:-1],
					   [TFPGCode waitCodeWithDuration:cornerWaitTime],
					   [TFPGCode codeForExtrusion:cornerExtrusion feedRate:-1],
					   ...
					   [TFPGCode moveWithPosition:[TFP3DVector vectorWithX:@(finalOffset) Y:@(finalOffset) Z:nil] extrusion:@1.5 feedRate:-1],
					   [TFPGCode moveWithPosition:[TFP3DVector vectorWithX:@(finalOffset) Y:@(finalOffset) Z:@3] extrusion:@5.3 feedRate:-1],
					   [TFPGCode codeForExtrusion:-finalRetraction feedRate:-1],
					   
					   [TFPGCode absoluteModeCode],
					   [TFPGCode moveWithPosition:[TFP3DVector xyVectorWithX:maxX y:maxY] feedRate:3000],
					   [TFPGCode moveWithPosition:[TFP3DVector zVector:20] feedRate:-1],
